...
from market_scout.models import ListingCreate, ProductCategory, ProductCondition
from market_scout.utils import random_delay, extract_price, extract_city, normalize_text, categorize_product
...
class BaseScraper(ABC):
    ...
    def normalize_condition(self, condition_text: str) -> ProductCondition:
        ...
        elif any(word in condition_text for word in ['כמו חדש', 'like new', 'excellent']):
