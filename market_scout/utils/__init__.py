...
def extract_city(text: str) -> Optional[str]:
    ...
    cities = [
        ...
        'אשדוד', 'רישון לציון', 'אשקלון', 'רעננה', 'רמת גן', 'הרצליה',
        'כפר סבא', 'חולון', 'בת ים', 'רמלה', 'Tel Aviv', 'Haifa', 
        'Jerusalem', 'Beer Sheva', 'Netanya', 'Petah Tikva'
    ]
...
def categorize_product(title: str, description: str = "") -> str:
    ...
    categories = {
        ...
        'gpu': ['gpu', 'graphics', 'video card', 'כרטיס מסך', 'nvidia', 'amd', 'rtx', 'gtx'],
