...
class TestAPIEndpoints:
    ...
    def test_category_stats(self, client, db_session):
        ...
        listings = [
            Listing(
                title="CPU 1", price=1000.0, currency="ILS",
                category=ProductCategory.CPU, condition=ProductCondition.GOOD,
                source_platform="test"
            ),
            Listing(
                title="CPU 2", price=1500.0, currency="ILS",
                category=ProductCategory.CPU, condition=ProductCondition.GOOD,
                source_platform="test"
            ),
            Listing(
                title="GPU 1", price=2000.0, currency="ILS",
                category=ProductCategory.GPU, condition=ProductCondition.GOOD,
                source_platform="test"
            )
        ]
